...
import yvWeiDingcang.service.BillService;
import yvWeiDingcang.service.DiningTableService;
import yvWeiDingcang.service.EmployeeService;
import yvWeiDingcang.service.MenuService;
import yvWeiDingcang.utils.Utility;

import java.util.List;

public class YvweiView {
    // 控制是否推出菜单
    ...
    public void mainMenu(){
        while(loop){
            System.out.println("///****=================知味堂后管理系统===============***///");
            System.out.println("\t\t\t ==========1 登录知味堂");
            System.out.println("\t\t\t ==========2 退出知味堂");
                    ...
                    if(employee!=null){
                        ...
                        while(loop){
                            ...
                            switch (key){
                                ...
                                case "9":
                                    loop = false;
                                    System.out.println("退出知味堂后台管理系统");
                                    break;
                                default:
    ...
    public static void main(String[] args) {
        YvweiView mhlView = new YvweiView();
        mhlView.mainMenu();
    }
}
